...
// TransferController handles requests for transferring assets.
type TransferController struct {
	Service *services.GatewayService
}

// NewTransferController creates a new TransferController instance.
func NewTransferController(setup *services.OrgSetup) *TransferController {
	return &TransferController{Service: services.NewGatewayService(setup)}
}
